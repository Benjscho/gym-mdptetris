...
class featureTests(unittest.TestCase):
    ...
    def test_well_sums(self):
        ...
        self.board.drop_piece(self.l.orientations[0], 2)
        self.board.drop_piece(self.l.orientations[0], 6)
        self.assertEqual(f.get_well_sums(self.board), 1)
        self.board.drop_piece(self.o.orientations[0], 4)
        ...
        self.board.drop_piece(self.l.orientations[0], 5)
        self.assertEqual(f.get_well_sums(self.board), 5)
        self.board.drop_piece(self.l.orientations[2], 2)
        self.assertEqual(f.get_well_sums(self.board), 7)
        self.board.reset()
    
    def test_well_sums_top_of_board(self):
        self.board.reset()
        for _ in range(10):
            self.board.drop_piece(self.o.orientations[0], 0)
            self.board.drop_piece(self.o.orientations[0], 3)
        self.assertEqual(f.get_well_sums(self.board), 20)
        self.board.reset()